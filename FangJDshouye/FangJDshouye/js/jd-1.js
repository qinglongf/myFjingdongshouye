...
//		$('#xiazminimg').mousemove(xiazminimgmove);
//		function xiazminimgmove(){
//			$('.xiazmax').show();
//		}
//		$('.xiazmax').mouseout(xiazminimgmoveout);
//		function xiazminimgmoveout(){
//			$(this).hide();
//		}
